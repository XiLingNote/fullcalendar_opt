...
(function (t, e) {
    ...
    function Z(e, n, r) {
        ...
        function h(t) {
            ...
            return t.getMonth() != n && o.push("fc-other-month"), +t == +r ? o.push("fc-today", le + "-state-highlight") : r > t ? o.push("fc-past") : o.push("fc-future"), a += "<td class='" + o.join(" ") + "'" + " data-date='" + xe(t, "yyyy-MM-dd") + "'" + ">" + "<div>", re && (a += "<div class='fc-day-number'>" + t.getDate() + "</div>"), a += "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div>  "+ "<input type='text' class = 'daliy' style='background-color:lightsteelblue ;width:40px;margin-top:60%' id='" + xe(t, "yyyy-MM-dd") + "'" + "/>" +"</div></td>"
        }
